...
def menu():
    ...
    sys.exit("Your messages are secure. El Psy Kongroo!")
...
def encrypt_submenu():    
    ...
    while usr_inp != "3":
        ...
        match usr_inp:
            ...
            case "2":
                encrypt_file_submenu()

def encrypt_string_submenu():
    usr_inp = None
    while usr_inp != "4":
        print("\n#####Encrypt String#####")
        print("# 1 - Provide a manual key.")
